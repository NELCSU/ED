var App = (function (exports) {
  ...
  ***************************************************************************** */
  ...
  function svg(container, options) {
      const parent = select$1(container);
  ...
  function drawColumnChart(node, data) {
      ...
      const sg = svg(node, { height: height, margin: margin, width: width });
  ...
  function Sankey() {
      ...
      sankey.nodeId = function (_) {
          return arguments.length ? (id = typeof _ === "function" ? _ : constant$6(_), sankey) : id;
      };
      sankey.nodeAlign = function (_) {
          return arguments.length ? (align = typeof _ === "function" ? _ : constant$6(_), sankey) : align;
      };
