...
VIZ.requiresData([
  ...
  trips.forEach(function (d) {
    ...
    var m = moment(d.begin*1000).utcOffset(-5);
  ...
  function renderTrainsAtTime(unixSeconds) {
    ...
    timeDisplay.text(moment(unixSeconds * 1000).utcOffset(-5).format('h:mm a'));
  }
  ...
  function renderMarey(outerSvg, fullMareyOuterWidth) {
    ...
    var yAxis = d3.svg.axis()
      ...
      .tickFormat(function (d) { return moment(d).utcOffset(-5).format("h:mm A"); })
    ...
    function select(time) {
      ...
      timeDisplay.text(moment(time * 1000).utcOffset(-5).format('h:mm a'));
    ...
    function highlightLinedUpMarey(d) {
      ...
      linedUp.appendOnce('text', 'mareyannotation start')
        ...
        .text(moment(first.time * 1000).utcOffset(-5).format('h:mma'));
      ...
      linedUp.appendOnce('text', 'mareyannotation end')
        ...
        .text(moment(last.time * 1000).utcOffset(-5).format('h:mma'));
    ...
    function drawLabels(selection, xScale, yScale) {
      ...
      labels.append('text')
          ...
          .text(function (d) {
            ...
            return moment(d.stop.time * 1000).utcOffset(-5).format('h:mma');
          })
