...
VIZ.requiresData([
  ...
  d3.selectAll('.interaction-all a.set-time')
    ...
    .on('mouseover', function () {
      ...
      var ms = moment(time + ' -0500', 'hh:mm a Z').utcOffset(-5).diff(moment(time + ' -0500', 'hh:mm a Z').utcOffset(-5).startOf('day'));
  ...
  var initalTime = moment('2/3/2014 5:30 PM -0500', 'M/D/YYYY hh:mm a Z').utcOffset(-5);
