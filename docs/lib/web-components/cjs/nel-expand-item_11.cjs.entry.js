...
class Tip {
    ...
    render() {
        ...
        return (index.h(index.Host, null, index.h("div", { class: cls, style: pos }, index.h("div", { class: clsWrapper }, index.h("progress", { class: clsBar, max: "100", value: "0" }), index.h("div", { class: "tip-message" }, index.h("slot", null)), index.h("div", { class: clsPanel }, index.h("span", { class: "tip-action" }, "pause"))))));
    }
    get host() { return index.getElement(this); }
    static get watchers() { return {
